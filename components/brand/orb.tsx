...
/**
 * Orb — AIEllie's signature iridescent sphere. Pure-CSS rendition of the
 * product's WebGL orb: a pink→violet→indigo gradient with a glossy highlight.
 *
 * NOTE: this is the existing AIEllie UI `Orb`. If it already lives in your
 * registry, delete this file and repoint the import in `ellie.tsx`.
 */
